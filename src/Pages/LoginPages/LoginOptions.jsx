    ...
    <Layout>
        <div className='w-full bg-red-200 flex  justify-center items-center my-2 h-screen'>
            <div className='flex flex-col w-1/2 items-center justify-center border-2'>
                ...
                <div onClick={()=>navigate("/login")} className="py-2 bg-black w-full text-center my-2 px-2 rounded-xl hover:cursor-pointer text-white">Admin Login</div>
                ...
                <div onClick={()=>navigate("/login")} className="py-2 bg-black w-full text-center my-2 px-2 rounded-xl hover:cursor-pointer text-white">Customer Login</div>
                </div>
            </div>
        </div>
        </Layout>
